<template>
    <div class="detail-list">
        ...
        <div class="doctor-info">
            <div class="avatar">
                <img src="./../../../common/imager/avatar.png" alt="">
            </div>
            <div class="info">
                <div>患者姓名：{{name}} </div>
                <div>患者卡号：{{cardno}}</div>
...
import zhprescription from "./zhprescription"
    export default {
        ...
        mounted(){
            ...
            this.name=data.name
            var dept_code = data.deptcode;
            if(dept_code.substring(0,6)=='100102'){
                this.type='2'
            }else if(dept_code.substring(0,6)=='100103'){
                this.type='3'
            }else{
                this.type='1'
            }
